...
$Cons="Select * From uvw_tbl_Productos Where (Fecha Between '".FormatoFecha($FechaInicial)."' and '".FormatoFecha($FechaFinal)."') $Filtro Order by Fecha DESC";
//echo $Cons;
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-sm-4">
                    <div class="title-action">
                        <a href="productos_add.php" class="btn btn-primary"><i class="fa fa-upload"></i> Cargar archivos</a>
                    </div>
                </div>
               <?php  //echo $Cons;?>
            </div>
							...
							<div class="form-group">
								...
								<div class="col-lg-3">
									<div class="input-daterange input-group" id="datepicker">
										<input name="FechaInicial" type="text" class="form-control" id="FechaInicial" placeholder="Fecha inicial" value="<?php echo $FechaInicial;?>"/>
										<span class="input-group-addon">hasta</span>
										<input name="FechaFinal" type="text" class="form-control" id="FechaFinal" placeholder="Fecha final" value="<?php echo $FechaFinal;?>" />
									</div>
								</div>
			...
			<div class="table-responsive">
                    ...
                    <?php while($row=sqlsrv_fetch_array($SQL)){ ?>
						 <tr class="gradeX">
							...
							<td><?php if($row['Archivo']!=""){?><a href="productdownload.php?file=<?php echo base64_encode($row['ID_Producto']);?>" target="_blank" class="btn btn-success btn-xs"><i class="fa fa-download"></i> Descargar</a><?php if(PermitirFuncion(205)||ConsultarUsuarioCargueProd($row['ID_Producto'])){?> <a href="#" onClick="EliminarRegistro(<?php echo $row['ID_Producto'];?>);" class="btn btn-danger btn-xs"><i class="fa fa-eraser"></i> Eliminar</a><?php }}else{?><p class="text-muted">Ninguno</p><?php }?></td>
						</tr>
					<?php }?>
                    </tbody>
                    </table>
