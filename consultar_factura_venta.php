                    ...
                    <?php
						...
						while($row=sqlsrv_fetch_array($SQL)){ ?>
						 <tr class="gradeX">
							...
							<td><a href="factura_venta.php?id=<?php echo base64_encode($row['ID_FacturaVenta']);?>&id_portal=<?php echo base64_encode($row['IdDocPortal']);?>&tl=1&return=<?php echo base64_encode($_SERVER['QUERY_STRING']);?>&pag=<?php echo base64_encode('consultar_factura_venta.php');?>" class="alkin btn btn-success btn-xs"><i class="fa fa-folder-open-o"></i> Abrir</a> <a href="sapdownload.php?id=<?php echo base64_encode('15');?>&type=<?php echo base64_encode('2');?>&DocKey=<?php echo base64_encode($row['ID_FacturaVenta']);?>&ObType=<?php echo base64_encode('13');?>&IdFrm=<?php echo base64_encode('0');?>" target="_blank" class="btn btn-warning btn-xs"><i class="fa fa-download"></i> Descargar</a></td>
						</tr>
					<?php }
						}?>
                    </tbody>
