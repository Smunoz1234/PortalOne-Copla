...
<title>Cargar productos | <?php echo NOMBRE_PORTAL;?></title>
<!-- InstanceEndEditable -->
             ...
             <div class="ibox-content">
              ...
              <form action="productos_add.php" method="post" class="form-horizontal" id="SeleccionarProducto">
				<div class="form-group">
					<label class="col-xs-12"><h3 class="bg-success p-xs b-r-sm"><i class="fa fa-cloud-upload"></i> Seleccione el producto para cargar la información</h3></label>
				</div>
               	<div class="form-group">					
				  <label class="col-sm-1 control-label">Producto</label>
					<div class="col-sm-5">
						<select name="Producto" required class="form-control select2" id="Producto">
					   ...
					   <div class="col-lg-12">
						   ...
						   <div class="col-lg-6">
							   <div class="form-group">
									...
									<div class="col-sm-8">
									<select required name="Categoria<?php echo $i;?>" class="form-control" id="Categoria<?php echo $i;?>" onChange="RevisarCat('<?php echo $i;?>');">
