...
//Variables globales
$Cons_Var="Select * From uvw_tbl_VariablesGlobales";
$SQL_Var=sqlsrv_query($conexion,$Cons_Var);
...
//Plantillas Email
$Cons_Noti="Select * From uvw_tbl_PlantillaEmail Where Estado=1";
$SQL_Noti=sqlsrv_query($conexion,$Cons_Noti);

//Datos del portal
$Cons_Datos="Select * From tbl_DatosPortal";
$SQL_Datos=sqlsrv_query($conexion,$Cons_Datos);
$row_Datos=sqlsrv_fetch_array($SQL_Datos);

//Tipo notificacion
$Cons_TipoNoti="Select * From tbl_TipoNotificacion";
...
<title><?php echo NOMBRE_PORTAL;?> | Par&aacute;metros generales</title>
<!-- InstanceEndEditable -->
			   ...
			   <div class="ibox-content">
				<div class="tabs-container">
					<ul class="nav nav-tabs">
						<li class="active"><a data-toggle="tab" href="#tab-1"><i class="fa fa-database"></i> Valores globales</a></li>
						<li class=""><a data-toggle="tab" href="#tab-2"><i class="fa fa-gear"></i> Configuraciones</a></li>
						<li class=""><a data-toggle="tab" href="#tab-3"><i class="fa fa-envelope"></i> Servidor SMTP</a></li>
						<li class=""><a data-toggle="tab" href="#tab-4"><i class="fa fa-paper-plane"></i> Notificaciones</a></li>
						<li class=""><a data-toggle="tab" href="#tab-5"><i class="fa fa-book"></i> Acuerdo de confidencialidad</a></li>
					</ul>
					<div class="tab-content">
                              	...
                              	<?php while($row_Var=sqlsrv_fetch_array($SQL_Var)){?>
										<div class="row">
											<div class="form-group">
												<label class="col-sm-3 control-label"><?php echo $row_Var['NombreMostrar'];?></label>
												<div class="col-sm-5">
						...
						<div id="tab-2" class="tab-pane <?php if($Tab==2){echo "active";}?>">
							<div class="panel-body">
								...
								<div class="row">
									<div class="form-group">
										<label class="col-sm-3 control-label">NIT de la empresa</label>
										<div class="col-sm-5">
								...
								<div class="row">
									<div class="form-group">
										...
										<div class="col-sm-1">
											<button onClick="ActualizarLogo(7);" type="button" class="ladda-button btn btn-info btn-sm" data-style="slide-right"><i class="fa fa-refresh"></i> Actualizar</button>
										</div>
										<div class="col-sm-1">
											<div id="Result_7"></div>
										</div>
											...
											<form class="form-horizontal" method="get">
												...
												<div class="col-sm-1">
													...
													<div class="col-sm-2">
														...
														<?php 
															$SQL_TipoNoti=sqlsrv_query($conexion,$Cons_TipoNoti);
						 ...
						 ?>		
							<div class="panel-body">
								...
								<div class="well">
									...
									<input type="hidden" id="P" name="P" value="31" />
