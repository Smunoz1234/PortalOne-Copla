...
//Proveedores
//$SQL_Proveedores=Seleccionar('uvw_Sap_tbl_Proveedores','*','','CardName');

//Empleados SAP
$SQL_Empleados=Seleccionar('uvw_Sap_tbl_Empleados','ID_Empleado, NombreEmpleado','','NombreEmpleado');

//Tipos de documentos SAP
$SQL_TiposDocumentos=Seleccionar('uvw_tbl_ObjetosSAP','*','','DeTipoDocumento');
						...
						<div id="tab-1" class="tab-pane active">
							...
							<div class="ibox-content">		
								...
								<div class="form-group">
									...
									<div id="Validar" class="col-lg-1"></div>
									<div class="col-lg-1">
									...
									<div class="col-lg-3">
										<select name="Proveedor" class="form-control select2" id="Proveedor">
										  ...
										  <?php /*while($row_Proveedores=sqlsrv_fetch_array($SQL_Proveedores)){?>
												<option value="<?php echo $row_Proveedores['CardCode'];?>" <?php if((strcmp($row_Proveedores['CardCode'],$row['CodigoSAPProv'])==0)){ echo "selected=\"selected\"";}?>><?php echo $row_Proveedores['CardName'];?></option>
										  <?php }*/?>
										</select>
								  </div>
								</div>
...
function addFieldTDoc(btn){//Clonar divDir
	...
	//button
	$newClone.children("div").eq(2).children("button").eq(0).attr('id','btnSeries'+newID);
