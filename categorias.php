							 ...
							 <div class="col-lg-6">
							  <form action="categorias.php" method="post" class="form-horizontal" id="AgregarCategoria">
								<div class="form-group">
									...
									<div class="col-sm-9"><input name="NombreCategoria" type="text" required="required" class="form-control" id="NombreCategoria" value="<?php if($edit==1){echo $row['NombreCategoria'];}?>"></div>
								</div>
								<div class="form-group">
