      ...
      <div class="d-flex col-lg-4 align-items-center bg-white p-5">
        ...
        <div class="d-flex col-sm-7 col-md-5 col-lg-12 px-0 px-xl-4 mx-auto">
          <div class="w-100">
            ...
            <h4 class="text-center text-lighter font-weight-normal mt-5 mb-0">Recordar contrase&ntilde;a</h4>
            ...
            <!-- / Form -->
			  <div class="text-light text-center small mt-4">
                Todos los derechos reservados &copy; 2018 <br> <?php echo NOMBRE_EMPRESA;?><br>Desarrollado por NEDUGA TECH S.A.S.
              </div>
          </div>
        </div>
      </div>
