...
function Resaltar(ID){
	$("input").removeClass('bg-primary');
	$("#"+ID).find("input").addClass('bg-primary');	
}
</script>
</head>
...
<form id="from" name="form">
	...
	<table width="100%" class="table table-bordered dataTables-example">
		...
		<tr id="<?php echo $i;?>" onClick="Resaltar('<?php echo $i;?>');">
			...
			<td class="text-center"><button type="button" title="Duplicar linea" class="btn btn-success btn-xs" onClick="DuplicarLinea(<?php echo $row['ID'];?>);"><i class="fa fa-copy"></i></button></td>
			...
			<td><input size="60" type="text" id="ListaMateriales<?php echo $i;?>" name="ListaMateriales[]" class="form-control" readonly value="<?php echo $row['DeArticuloLMT'];?>"></td>
