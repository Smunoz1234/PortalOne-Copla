...
if((isset($_POST['Cliente'])&&($_POST['Cliente'])!="")||(isset($_GET['Cliente'])&&($_GET['Cliente'])!="")){
	...
	$ConsDatos="Select * From uvw_tbl_AlertasInformes Where CardCode='".$Cliente."' and Anno='".$Anno."'";
				...
				<div class="col-lg-12">   
					<div class="ibox-content"> 
						<div class="form-group">
							<label class="col-xs-12"><h3 class="bg-muted p-xs b-r-sm"><i class="fa fa-group"></i> Seleccione el cliente para cargar la información</h3></label>
						</div>
						<form action="gestionar_alertas.php" method="post" class="form-horizontal" id="SeleccionarCliente">
							<div class="form-group">
								...
								<div class="col-sm-2">
									<select name="Anno" required class="form-control m-b" id="Anno">
										<option value="2017" <?php if((isset($Anno))&&(strcmp(2017,$Anno)==0)){ echo "selected=\"selected\"";}?>>2017</option>
										<option value="2018" <?php if((isset($Anno))&&(strcmp(2018,$Anno)==0)){ echo "selected=\"selected\"";}?>>2018</option>
          ...
          <div class="row">
			  <div class="col-lg-12">
				  <div class="ibox-content">
					  ...
					  <div class="row">
						   <div class="col-xs-10">
						   		<label class="col-xs-12"><h3 class="bg-muted p-xs b-r-sm"><i class="fa fa-calendar"></i> Configure las alertas</h3></label>
							</div>
						  <div class="col-xs-2">
...
<td><input class="form-control" type="text" name="Diciembre[]" id="Diciembre<?php echo $Cont;?>" maxlength="2" placeholder="Día" value="" onKeyPress="return justNumbersOnly(event);"></td>
					...
					<input type="hidden" name="Anno" id="Anno" value="<?php echo base64_encode($Anno);?>" />
				</form>
				  </div>	   
			  </div>
          </div>
