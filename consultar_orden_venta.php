...
$Cons="Select * From uvw_Sap_tbl_OrdenesVentas Where $WhereFecha $Filtro Order by DocNum DESC";
...
<title>Consultar orden de venta | <?php echo NOMBRE_PORTAL;?></title>
<!-- InstanceEndEditable -->
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-8">
                    <h2>Consultar orden de venta</h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong>Consultar orden de venta</strong>
                        </li>
                    </ol>
                </div>
            </div>
         <div class="wrapper wrapper-content">
             <div class="row">
			    ...
			    <div class="ibox-content">
				  ...
				  <form action="consultar_orden_venta.php" method="get" id="formBuscar" class="form-horizontal">
                    ...
                    <?php
						...
						while($row=sqlsrv_fetch_array($SQL)){ ?>
						 <tr class="gradeX">
							...
							<td><a href="orden_venta.php?id=<?php echo base64_encode($row['ID_OrdenVenta']);?>&id_portal=<?php echo base64_encode($row['IdDocPortal']);?>&tl=1&return=<?php echo base64_encode($_SERVER['QUERY_STRING']);?>&pag=<?php echo base64_encode('consultar_orden_venta.php');?>" class="alkin btn btn-success btn-xs"><i class="fa fa-folder-open-o"></i> Abrir</a> <a href="sapdownload.php?id=<?php echo base64_encode('15');?>&type=<?php echo base64_encode('2');?>&DocKey=<?php echo base64_encode($row['ID_OrdenVenta']);?>&ObType=<?php echo base64_encode('17');?>&IdFrm=<?php echo base64_encode('0');?>" target="_blank" class="btn btn-warning btn-xs"><i class="fa fa-download"></i> Descargar</a></td>
						</tr>
					<?php }
						}?>
                    </tbody>
