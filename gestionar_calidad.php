...
<title>Gestionar documentos calidad | <?php echo NOMBRE_PORTAL;?></title>
<!-- InstanceEndEditable -->
			...
			if(id!=""){
				Swal.fire({
					...
					if (result.isConfirmed) {
						...
						location.href='registro.php?P=13&type=4&id='+id;
					}
				});
			}
		}
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Gestionar calidad</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-sm-4">
                    <div class="title-action">
                        <a href="calidad_add.php" class="btn btn-primary"><i class="fa fa-upload"></i> Cargar documentos</a>
                    </div>
                </div>
               <?php  //echo $Cons;?>
            </div>
				...
				<div class="col-lg-12">
					<div class="ibox-content">
						<?php include("includes/spinner.php"); ?>
			  			<form action="gestionar_calidad.php" method="get" id="formBuscar" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-lg-3">
								 <?php include_once("includes/select_categorias_calidad.php"); ?>
								</div>
								<div class="col-lg-1">
