...
<title>Editar categor&iacute;a | <?php echo NOMBRE_PORTAL;?></title>
	<!-- InstanceEndEditable -->
           ...
           <div class="col-lg-6">
              <form action="registro.php" method="post" class="form-horizontal" id="AgregarCategoria">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input name="ParamAdicionales" type="text" class="form-control" id="ParamAdicionales" value="<?php echo $row['ParamAdicionales'];?>">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-9">
