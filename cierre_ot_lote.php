				  ...
				  <form action="cierre_ot_lote.php" method="get" id="formBuscar" class="form-horizontal">
					  <div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-lg-2">
								<select name="Sucursal" class="form-control m-b" id="Sucursal" required>
							...
							<div class="col-lg-2">
								<select name="Series" class="form-control m-b" id="Series" required>
										<option value="">Seleccione...</option>
								  <?php if($sw==1){ 
		 ...
		 <div class="row">
           <div class="col-lg-12">
			    <div class="ibox-content">
					...
					<div class="row">
						<div class="col-lg-8">
							<button class="btn btn-primary btn-lg btn-outline m-b-md" type="button" id="CierreLlamadas" onClick="Validar('2');"><i class="fa fa-play-circle"></i> 2. Cerrar llamadas de servicio</button>
					...
					<button class="btn btn-success btn-lg btn-outline m-b-md" type="button" id="CierreAct" onClick="Validar('1');"><i class="fa fa-play-circle"></i> 1. Cerrar actividades</button>
