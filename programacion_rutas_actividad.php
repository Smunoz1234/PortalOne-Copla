...
<div class="modal-content">
  ...
  <div class="modal-body">
	...
	<ul class="nav nav-tabs" id="myTab" role="tablist">
		...
		<li class="nav-item">
			<a class="nav-link" data-toggle="tab" href="#tab-5"><i class="fas fa-map-marker-alt"></i> Ubicación GPS</a>
	  	</li>
		<?php }?>
	</ul>
	<div class="tab-content" id="myTabContent">
		<div class="tab-pane fade show active" id="tab-1">
			...
			<div class="form-group row">
				<label class="col-lg-1 col-form-label"><?php if(($type_act==1)&&($row['ID_LlamadaServicio']!=0)){?><a href="actividad.php?id=<?php echo base64_encode($row['DocEntry']);?>&tl=1" target="_blank" title="Consultar actividad" class="btn-xs btn-success fas fa-search"></a> <?php }?>ID Actividad</label>
				<div class="col-lg-3">
		...
		<div class="tab-pane fade" id="tab-5">
			<div class="google-map" id="map"><?php if($row['LatitudGPS']==""||$row['LongitudGPS']==""){echo "<br><p>No hay datos para mostrar.</p>";}?></div>			
		</div>
		<?php }?>
	</div>
