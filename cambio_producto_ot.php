		 ...
		 <div class="row">
           <div class="col-lg-12">
			    <div class="ibox-content">
					...
					<div class="row">
						<div class="col-lg-8">
							<button class="btn btn-success btn-lg" disabled type="button" id="Ejecutar" onClick="EjecutarProceso('1');"><i class="fa fa-play-circle"></i> Ejecutar transacción</button>
