          ...
          <div class="row">
           <div class="col-lg-12">
             <div class="ibox-content">
              ...
              <br>
               <form action="calidad_add.php" method="post" class="form-horizontal" id="SeleccionarCliente">
              ...
              <?php }else*/if($Step==2){
			   ...
			   <div class="row">
				   <div class="col-lg-12">
					   <form action="calidad_add.php" method="post" class="form-horizontal" id="AgregarArchivos">
							<div class="col-sm-9">
								<button class="btn btn-primary" type="submit">Continuar <i class="fa fa-arrow-circle-right"></i></button> <a href="gestionar_calidad.php" class="btn btn-outline btn-default"><i class="fa fa-arrow-circle-o-left"></i> Cancelar</a>
							</div>
               ...
               <?php /*?>	<div class="form-group">
				  <p class="text-primary">Cliente:<br><strong><?php echo $NombreCliente;?></strong></p>
				</div>
	   			<br><?php */?>
		   		<?php 
				$temp=ObtenerVariable("CarpetaTmp");
			   ...
			   <br>
		   		<div class="form-group">
					<div class="col-sm-9">
						<button class="btn btn-primary" id="toggleSpinners" type="submit">Continuar <i class="fa fa-arrow-circle-right"></i></button> <a href="gestionar_calidad.php" class="btn btn-outline btn-default"><i class="fa fa-arrow-circle-o-left"></i> Cancelar</a>
					</div>
				</div>
				<input type="hidden" id="P" name="P" value="28" />
