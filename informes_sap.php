			    ...
			    <div class="ibox-content">
				  ...
				  <form action="sapdownload.php" method="post" id="formInforme" class="form-horizontal">
					  <div class="form-group">
						<label class="col-lg-12"><h3 class="bg-muted p-xs b-r-sm"><i class="fa fa-check-square-o"></i> Críterios de selección</h3></label>
					  </div>
					  <?php
					if($Num_Campos>0){
					  while($row_Campos=sqlsrv_fetch_array($SQL_Campos)){
					  	if($row_Campos['TipoCampo']=="Texto"){?>
							<div class="form-group">
								<label class="col-lg-2 control-label"><?php echo $row_Campos['LabelCampo'];?></label>
								<div class="col-lg-3">
