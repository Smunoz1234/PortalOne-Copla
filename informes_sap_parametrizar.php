    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
         ...
         <div class="wrapper wrapper-content">
          ...
          <div class="row"> 
           <div class="col-lg-12">
              	<h3 class="bg-muted p-xs b-r-sm"><i class="fa fa-info-circle"></i> Seleccione el informe a parametrizar</h3>
				<br>
				<form action="informes_sap_parametrizar.php" method="post" class="form-horizontal" id="Consultar">
					<div class="form-group">
						...
						<div class="col-lg-2">
							<button type="submit" class="btn btn-outline btn-info"><i class="fa fa-search"></i> Consultar</button>
						</div>
					</div>
				</form>
		   </div>
			...
			<br>
			 ...
			 <div class="row">
				<div class="col-lg-12">
					<div class="ibox-content">
						<?php include("includes/spinner.php"); ?>
						<h3 class="bg-info p-xs b-r-sm"><i class="fa fa-check-circle-o"></i> Configure los campos del informe</h3><br>
						 <form action="informes_sap_parametrizar.php" method="post" id="frmCampos" class="form-horizontal">
							 <div class="form-group">
								...
								<label class="col-lg-2 control-label text-success">Nombre del reporte</label>
								<div class="col-lg-3">
