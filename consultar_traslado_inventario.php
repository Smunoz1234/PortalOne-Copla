...
if(isset($_GET['Estado'])&&$_GET['Estado']!=""){
	$Filtro.=" and Cancelado='".$_GET['Estado']."'";
}
					  	...
					  	<div class="form-group">
							...
							<div class="col-lg-3">
								<select name="Estado" class="form-control" id="Estado">
									<option value="">(Todos)</option>
									<option value="N" <?php if(isset($_GET['Estado'])&&($_GET['Estado']=='N')){ echo "selected=\"selected\"";}?>>OK</option>
									<option value="Y" <?php if(isset($_GET['Estado'])&&($_GET['Estado']=='Y')){ echo "selected=\"selected\"";}?>>CANCELADO</option>
								</select>
							</div>
                    ...
                    <?php
						...
						while($row=sqlsrv_fetch_array($SQL)){ ?>
						 <tr class="gradeX">
							...
							<td><span <?php if($row['Cancelado']=='Y'){echo "class='label label-danger'";}else{echo "class='label label-primary'";}?>><?php if($row['Cancelado']=='Y'){echo "Cancelado";}else{echo "OK";}?></span></td>
