...
$SQL=Seleccionar("uvw_tbl_CierreOTActividadesCarrito","*","Usuario='".strtolower($_SESSION['User'])."' $FiltroOT");
if($SQL){
	$sw=1;
}
...
<form id="from" name="form">
	...
	<table width="100%" class="table table-bordered">
		...
		<tr>
			...
			<td><input size="50" type="text" id="Ejecucion<?php echo $i;?>" name="Ejecucion[]" class="form-control bg-info" readonly value="<?php echo $row['Ejecucion'];?>" title="<?php echo $row['Ejecucion'];?>"></td>
		</tr>
		<?php 
			$i++;}
		}
