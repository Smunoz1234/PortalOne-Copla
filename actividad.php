...
if(isset($_POST['P'])&&($_POST['P']==42)){//Reabrir actividad
	try{
		...
		$Client->ReabrirActividadPortal($Parametros);
		$Respuesta=$Client->__getLastResponse();
		$Contenido=new SimpleXMLElement($Respuesta,0,false,"s",true);
		$espaciosDeNombres = $Contenido->getNamespaces(true);
		$Nodos = $Contenido->children($espaciosDeNombres['s']);
...
if($type_act==1&&$sw_error==0){//Editando la actividad
	...
	//Orden de servicio
	$SQL_OrdenServicioCliente=Seleccionar('uvw_Sap_tbl_LlamadasServicios','ID_LlamadaServicio, DocNum, AsuntoLlamada',"ID_CodigoCliente='".$row['ID_CodigoCliente']."' and NombreSucursal='".$row['NombreSucursal']."'",'AsuntoLlamada');
}
    ...
    <div id="page-wrapper" class="gray-bg">
      ...
      <div class="wrapper wrapper-content">
		<div class="ibox-content">
          ...
          <div class="row"> 
           <div class="col-lg-12">
			   <form action="actividad.php" method="post" class="form-horizontal" enctype="multipart/form-data" id="CrearActividad" onSubmit="return ComprobarExt()&& ValidarHoras();">
			   <?php if($type_act==1){?>
				<div class="form-group">
					<div class="col-lg-3">
						<div class="form-group border">
							<div class="p-xs">
								<label class="text-muted">N&uacute;mero</label>
								<div class="font-bold h6"><?php echo $row['ID_Actividad'];?></div>
							</div>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group border">
							<div class="p-xs">
								<label class="text-muted">Creada por</label>
								<div class="font-bold h6"><?php if($sw_error==0&&$row['DeAsignadoPor']!=""){echo $row['DeAsignadoPor'];}else{echo "&nbsp;";}?></div>
							</div>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group border">
							<div class="p-xs">
								...
								<div class="font-bold h6"><?php if($sw_error==0&&$row['FechaCreacion']!=""){echo $row['FechaCreacion']." ".$row['HoraCreacion'];}else{echo "&nbsp;";}?></div>
							</div>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group border">
							<div class="p-xs">
								<label class="text-muted">Actualizado por</label>
								<div class="font-bold h6"><?php if($sw_error==0&&$row['UsuarioActualizacion']!=""){echo $row['UsuarioActualizacion'];}else{echo "&nbsp;";}?></div>
							</div>
						</div>
					</div>
					<div class="col-lg-3">
						<div class="form-group border">
							<div class="p-xs">
								<label class="text-muted">Fecha actualización</label>
								<div class="font-bold h6"><?php if($sw_error==0&&$row['FechaActualizacion']!=""){echo $row['FechaActualizacion']." ".$row['HoraActualizacion'];}else{echo "&nbsp;";}?></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="ibox">
					...
					<div class="ibox-content">
						<div class="form-group">
							<label class="col-lg-1 control-label">Titulo actividad</label>
							<div class="col-lg-7">
						...
						<div id="DatosActividad" class="form-group">
							<label class="col-lg-1 control-label">Tipo asunto</label>
							<div class="col-lg-3">
							...
							<label class="col-lg-1 control-label">En ruta</label>
							<div class="col-lg-3">
						...
						<div class="form-group">
							<label class="col-lg-1 control-label">Tipo asignado</label>
							<div class="col-lg-3">
				   ...
				   <label class="col-lg-1 control-label">Motivo de cierre</label>
					...
					<label class="col-lg-1 control-label">Tipo estado actividad</label>
					<div class="col-lg-3">
				...
				<div class="ibox">
					...
					<div class="ibox-content">
						<div class="form-group">
							...
							<div class="col-lg-3">
								<select name="ContactoCliente" class="form-control" id="ContactoCliente" <?php if(($type_act==1)&&(!PermitirFuncion(304)||($row['IdEstadoActividad']=='Y'))){ echo "disabled='disabled'";}?>>
							...
							<div class="col-lg-3">
								<select name="SucursalCliente" class="form-control select2" id="SucursalCliente" <?php if(($type_act==1)&&(!PermitirFuncion(304)||($row['IdEstadoActividad']=='Y'))){ echo "disabled='disabled'";}?>>
									<?php if(($type_act==0)||($sw_error==1)){?><option value="">Seleccione...</option><?php }?>
				...
				<div class="ibox">
					...
					<div class="ibox-content">
						<div class="form-group">
							...
							<div class="col-lg-6">
								<textarea name="Comentarios" rows="7" maxlength="1000" class="form-control" id="Comentarios" type="text" <?php if(($type_act==1)&&(!PermitirFuncion(304)||($row['IdEstadoActividad']=='Y')||($BloqEdit==1))){ echo "readonly='readonly'";}?>><?php if(($type_act==1)||($sw_error==1)){echo $row['ComentariosActividad'];}?></textarea>
							</div>
						</div>
						<div class="form-group">
				...
				<?php if($type_act==1){?>
			   	<div class="ibox">
					...
					<div class="ibox-content">
						<div class="form-group">
							<div class="col-lg-11">
								<textarea name="NotasActividad" rows="10" class="form-control" id="NotasActividad" placeholder="Escriba los comentarios de los trabajos realizados..." type="text" <?php if(($type_act==1)&&(!PermitirFuncion(304)||($row['IdEstadoActividad']=='Y'))){ echo "readonly='readonly'";}?>><?php if(($type_act==1)||($sw_error==1)){echo $row['NotasActividad'];}?></textarea>
							</div>
						</div>
						<div class="form-group">
							<div class="col-lg-9">
...
<script>
	 $(document).ready(function(){
		...
		<?php if(!((($dt_LS==1)&&(base64_decode($_GET['TTarea'])=='Interna')||($dt_DM==1)))){?>
