...
$Cons="Select * From uvw_Sap_tbl_OfertasVentas Where (DocDate Between '$FechaInicial' and '$FechaFinal') $Filtro Order by DocNum DESC";
//echo $Cons;
...
<title><?php echo NOMBRE_PORTAL;?> | Consultar oferta de venta</title>
<!-- InstanceEndEditable -->
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-8">
                    <h2>Consultar oferta de venta</h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong>Consultar oferta de venta</strong>
                        </li>
                    </ol>
                </div>
            </div>
         <div class="wrapper wrapper-content">
             <div class="row">
			    ...
			    <div class="ibox-content">
				  ...
				  <form action="consultar_oferta_venta.php" method="get" id="formBuscar" class="form-horizontal">
