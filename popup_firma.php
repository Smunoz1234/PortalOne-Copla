...
<title><?php echo NOMBRE_PORTAL;?> | Firmar</title>
<style>
*,
*::before,
*::after {
  ...
  if (signaturePad.isEmpty()) {
    ...
    $.ajax({
			...
			success: function(response){
				...
				$("#msgsig").html('<div class="alert alert-success"><i class="fa fa-thumbs-up"></i> La firma ha sido cargada exitosamente. Ahora debe actualizar el documento para guardar la firma.</div>').show('slow');
